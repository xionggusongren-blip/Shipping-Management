"""
IBM i (DB2) 接続モジュール
- 本番: JayDeBeApi + jt400.jar 経由でJDBC接続
...
def fetch_from_ibmi() -> List[Dict[str, Any]]:
    ...
    try:
        ...
        logger.error("JayDeBeApi がインストールされていません。DEMO_MODE=true を設定してください")
        raise RuntimeError("JayDeBeApi not installed")
